...
def dayLength(doy, lat):
    ...
    dec = pcr.scalar(0.39785 * pcr.sin((4.868961 + .017203 * doy +
                                        0.033446 * pcr.sin(dec * 180 / math.pi)) * 180 / math.pi))
    dec = pcr.scalar(pcr.asin(dec))
    lat = pcr.ifthenelse(pcr.abs(lat) > M_PI_2, (M_PI_2 - pcr.scalar(0.01))
