...
netcdf_monthly_total_unit[pcrglobwb_variable_name] = None
netcdf_yearly_total_unit[pcrglobwb_variable_name] = None
# next 30-150 cm of soil
netcdf_long_name[pcrglobwb_variable_name] = 'lower_soil_storage'
description[pcrglobwb_variable_name] = None
comment[pcrglobwb_variable_name] = None
latex_symbol[pcrglobwb_variable_name] = None
...
netcdf_yearly_total_unit[pcrglobwb_variable_name] = 'm.year-1'
netcdf_long_name[
    pcrglobwb_variable_name] = 'total_plant_transpiration_from_upper_soil_storage(s)'
description[pcrglobwb_variable_name] = None
comment[pcrglobwb_variable_name] = None
latex_symbol[pcrglobwb_variable_name] = None
...
netcdf_long_name[pcrglobwb_variable_name] = None
description[
    pcrglobwb_variable_name] = "Total abstraction from all water sources: surface water, non fossil groundwater and other water sources (e.g. fossil groundwater, desalinisation)."
comment[pcrglobwb_variable_name] = None
latex_symbol[pcrglobwb_variable_name] = None
